...
. Geben Sie auf der Seite *Scripts* die Befehle für Pre Clone oder Post Clone ein, die vor bzw. nach dem Klonvorgang ausgeführt werden sollen. Geben Sie den Mount-Befehl ein, um ein Dateisystem auf einen Host zu mounten.
+
Beispiel:
