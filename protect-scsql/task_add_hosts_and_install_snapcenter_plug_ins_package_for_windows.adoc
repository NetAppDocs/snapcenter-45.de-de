...
+
.. Klicken Sie auf *Logverzeichnis konfigurieren* und auf der Seite *Hostprotokollverzeichnis konfigurieren* auf *Durchsuchen* und führen Sie die folgenden Schritte aus:
+
