...
Datenbanken können nicht gesichert werden, wenn die Option *Gesamtstatus* auf der Seite *Details* für die Sicherung nicht verfügbar ist. Die Option *Gesamtstatus* ist für die Sicherung auf nicht verfügbar eingestellt, wenn eine der folgenden Optionen zutrifft:
