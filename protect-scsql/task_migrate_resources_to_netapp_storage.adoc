...
. Wählen Sie auf der Seite *Ressourcen* aus der Dropdown-Liste *Ansicht* * die Option *Datenbank* oder *Instanz* aus.
. Wählen Sie entweder die Datenbank oder die Instanz aus der Liste aus und klicken Sie auf *Migrieren*.
. Führen Sie auf der Seite *Ressourcen* folgende Aktionen durch:
+
|===
...
|===
. Führen Sie auf der Seite * Verify* die folgenden Aktionen durch:
+
|===
| Für dieses Feld... | Tun Sie das... 
