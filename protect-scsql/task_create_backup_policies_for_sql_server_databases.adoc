...
. Führen Sie auf der Seite *Backup-Typ* die folgenden Schritte aus:
+
...
. Führen Sie auf der Seite *Retention* abhängig vom auf der Seite Backup type ausgewählten Backup-Typ eine oder mehrere der folgenden Aktionen durch:
+
...
|===
. Geben Sie auf der Seite *Script* den Pfad und die Argumente des Preskript oder Postscript ein, die vor oder nach dem Backup ausgeführt werden sollen.
+
...
+
.. Wählen Sie im Abschnitt *Überprüfung ausführen für folgende Backup-Zeitpläne* die Zeitplanhäufigkeit aus.
.. Führen Sie im Abschnitt *Datenbankkonsistenzprüfoptionen* die folgenden Aktionen durch:
+
|===
| Für dieses Feld... | Tun Sie das... 
