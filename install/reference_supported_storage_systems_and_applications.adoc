...
* SnapCenter unterstützt Amazon FSX für NetApp ONTAP aus dem Patch-Release der SnapCenter Software 4.5 P1.
+
Wenn Sie Amazon FSX für NetApp ONTAP verwenden, stellen Sie sicher, dass die SnapCenter Server Host-Plug-ins auf die Patch-Version 4.5 P1 aktualisiert werden, um Datensicherungsprozesse auszuführen.
...
+
Ausführliche Informationen zu den unterstützten Anwendungen und Datenbanken finden Sie unter https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["NetApp Interoperabilitäts-Matrix-Tool"^].
