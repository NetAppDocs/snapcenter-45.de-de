...
. Suchen Sie in der Liste *Storage Connections* die Spalte Controller License.
+
...
+
Informationen zu den Cmdlets finden Sie unter https://library.netapp.com/ecm/ecm_download_file/ECMLP2877143["SnapCenter Software Cmdlet Referenzhandbuch"^].
