...
. Führen Sie auf der Seite Speichersysteme aus dem Dropdown-Menü *Typ* eine der folgenden Aktionen aus:
+
|===
| Auswählen... | Schritte... 
...
.. Klicken Sie auf der Seite Speichersystem ändern neben Benutzername auf das Bearbeiten-Symbol und ändern Sie den Benutzernamen und das Kennwort.
