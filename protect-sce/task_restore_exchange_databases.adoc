...
. Geben Sie auf der Seite Skript den Pfad und die Argumente des Vorskripts bzw. des Postskripts ein, die vor bzw. nach der Wiederherstellung ausgeführt werden sollen.
+
